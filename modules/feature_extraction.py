...
class ResNet(nn.Module):
    ...
    def __init__(self, input_channel, output_channel, block, layers):
        ...
        self.conv0_1 = nn.Conv2d(input_channel, int(output_channel / 16), kernel_size=3, padding=1, bias=False)
        self.bn0_1 = nn.BatchNorm2d(int(output_channel / 16))
        self.conv0_2 = nn.Conv2d(int(output_channel / 16), self.inplanes, kernel_size=3, padding=1, bias=False)
